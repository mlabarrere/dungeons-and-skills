...
(function () {
  ...
  function safeHref(href, root) {
    if (!href || !/^(?:\/|\.{0,2}\/)[^\s]*$/.test(href)) return null;
    return href.charAt(0) === "/" ? root + href : href;
  }
  ...
  function buildFooter() {
    ...
    footer.appendChild(document.createTextNode(fr
      ? "Dungeons & Skills — base documentaire HTML (source de vérité). Aide personnelle de référence, usage privé de table. "
      : "Dungeons & Skills — HTML reference. Personal tabletop aid. "));
    ...
    home.textContent = fr ? "Accueil" : "Home";
    footer.appendChild(home);
    footer.appendChild(document.createTextNode(" · "));
    var styleguide = document.createElement("a");
    styleguide.href = root + "/styleguide.html";
    styleguide.textContent = "Styleguide";
    footer.appendChild(styleguide);
    document.body.appendChild(footer);
  }
